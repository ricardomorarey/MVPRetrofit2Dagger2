package com.ricardomorarey.examplemvpdaggerretrofit;
...
import com.ricardomorarey.examplemvpdaggerretrofit.http.TwitchAPI;
import com.ricardomorarey.examplemvpdaggerretrofit.http.twitch.Game;
import com.ricardomorarey.examplemvpdaggerretrofit.http.twitch.Twitch;
import com.ricardomorarey.examplemvpdaggerretrofit.login.LoginActivityMVP;
import com.ricardomorarey.examplemvpdaggerretrofit.root.App;
...
public class LoginActivity extends AppCompatActivity implements LoginActivityMVP.View {
    ...
    @Nullable
    @BindViews({R.id.edit_text_first_name, R.id.edit_text_last_name, R.id.button_login})
    List<View> inputs;
